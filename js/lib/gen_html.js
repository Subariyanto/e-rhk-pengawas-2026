...
(function () {
  ...
  function ttdBlokStandar(idn, rhkId) {
    ...
    const ketuaTTDImg = (i.ttd_ketua_pokjawas) ? `<img class="signature-img" src="${i.ttd_ketua_pokjawas}" style="max-height:240px;position:absolute;top:-80px;left:50%;transform:translateX(-50%);z-index:1;mix-blend-mode:multiply;background:transparent;" />` : '<div style="height:80px;"></div>';
    return `
  ...
  function ttdTriwulan(idn, rhkId) {
    ...
    const ketuaTTDImg = (i.ttd_ketua_pokjawas) ? `<img class="signature-img" src="${i.ttd_ketua_pokjawas}" style="max-height:240px;position:absolute;top:-80px;left:50%;transform:translateX(-50%);z-index:1;mix-blend-mode:multiply;background:transparent;" />` : '';
